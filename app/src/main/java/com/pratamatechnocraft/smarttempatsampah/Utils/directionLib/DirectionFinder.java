...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyCkaSZGLRb2EoDfOytG294cZ9KsiQWEB18";
    ...
    private String createUrl() throws UnsupportedEncodingException {
        ...
        return DIRECTION_URL_API + "origin=" + urlOrigin + "&destination=" + urlDestination + "&waypoints=" + wayPoints + "&key=" + GOOGLE_API_KEY;
    }
